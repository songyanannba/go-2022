...
func (cr ConsulRegistry) Register(name, id string, port int, tag []string) error {
	...
	agentServiceReg.Tags = tag

	serverAddr := fmt.Sprintf("http://%s:%d/health", internal.AppConf.StockSrvConfig.Host,
