...
func (x *BoolRequest) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
var file_book_proto_rawDesc = []byte{
	...
	0x22, 0x21, 0x0a, 0x0b, 0x42, 0x6f, 0x6f, 0x6c, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	...
	0x6c, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x10, 0x2e, 0x70, 0x62, 0x2e, 0x42, 0x6f,
...
var file_book_proto_goTypes = []interface{}{
	(*BoolRequest)(nil),  // 0: pb.BoolRequest
	(*BookResponse)(nil), // 1: pb.BookResponse
}
var file_book_proto_depIdxs = []int32{
	0, // 0: pb.Study.Study:input_type -> pb.BoolRequest
...
type StudyClient interface {
	Study(ctx context.Context, in *BoolRequest, opts ...grpc.CallOption) (*BookResponse, error)
}
...
func (c *studyClient) Study(ctx context.Context, in *BoolRequest, opts ...grpc.CallOption) (*BookResponse, error) {
...
type StudyServer interface {
	Study(context.Context, *BoolRequest) (*BookResponse, error)
}
...
func (*UnimplementedStudyServer) Study(context.Context, *BoolRequest) (*BookResponse, error) {
...
func _Study_Study_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StudyServer).Study(ctx, req.(*BoolRequest))
	}
